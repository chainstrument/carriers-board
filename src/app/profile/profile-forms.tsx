...
export function ProfileForms({ name, email, image }: { name: string; email: string; image: string | null }) {
  ...
  return (
    <div className="space-y-10">
      <form action={profileAction} className="space-y-4 rounded-lg border border-neutral-200 p-6 dark:border-neutral-800">
        <h3 className="font-medium text-neutral-900 dark:text-neutral-100">Informations</h3>
        ...
        <div className="space-y-1">
          <label htmlFor="name" className="text-sm text-neutral-600 dark:text-neutral-400">Nom</label>
          <input
            id="name"
            name="name"
            defaultValue={name}
        ...
        <div className="space-y-1">
          <label htmlFor="image" className="text-sm text-neutral-600 dark:text-neutral-400">Avatar (URL)</label>
          <input
            id="image"
            name="image"
            defaultValue={image ?? ""}
      ...
      <form action={passwordAction} className="space-y-4 rounded-lg border border-neutral-200 p-6 dark:border-neutral-800">
        <h3 className="font-medium text-neutral-900 dark:text-neutral-100">Mot de passe</h3>

        <div className="space-y-1">
          <label htmlFor="currentPassword" className="text-sm text-neutral-600 dark:text-neutral-400">
            Mot de passe actuel
          </label>
          <input
            id="currentPassword"
        ...
        <div className="space-y-1">
          <label htmlFor="newPassword" className="text-sm text-neutral-600 dark:text-neutral-400">
