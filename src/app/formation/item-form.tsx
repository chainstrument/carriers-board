    ...
    <form action={formAction} className="space-y-4">
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="space-y-1">
          <label htmlFor="type" className="text-sm text-neutral-600 dark:text-neutral-400">
            Type
          </label>
          <select id="type" name="type" defaultValue={defaultValues?.type ?? "book"} className={inputClass}>
            {TYPE_OPTIONS.map((o) => (
