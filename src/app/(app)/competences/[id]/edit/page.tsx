      ...
      <div className="rounded-lg border border-neutral-200 p-6 dark:border-neutral-800">
        ...
        {competence.linkedExperiences.length === 0 ? (
          <p className="mt-1 text-sm text-neutral-500">
            Pas encore liée à une expérience — la date de dernière utilisation
            ci-dessus est donc saisie manuellement.
          </p>
        ) : (
          <>
            <p className="mt-1 text-sm text-neutral-500">
              La dernière utilisation ({competence.lastUsed.date}) est calculée
              automatiquement à partir de ces expériences, le champ manuel est
              ignoré tant qu&apos;au moins une liaison existe.
            </p>
        ...
        <p className="mt-3 text-xs text-neutral-400">
          La liaison aux projets sera disponible une fois l&apos;Epic Projets
          implémenté.
        </p>
      </div>
