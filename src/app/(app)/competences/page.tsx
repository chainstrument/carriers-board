    ...
    <div className="mx-auto max-w-3xl px-6 py-16">
      ...
      {competences.length === 0 && (
        <p className="text-neutral-500">
          Aucune compétence pour l&apos;instant. Elles se créent aussi
          automatiquement en listant les technologies d&apos;une expérience.
        </p>
      )}
                ...
                >
                  ...
                  <div className="flex items-center gap-4 text-xs text-neutral-500">
                    {c.yearsOfExperience !== null && (
                      <span>{c.yearsOfExperience} an(s)</span>
                    )}
                    <span>
                      Niveau <LevelDots value={c.level} />
                    </span>
                    {c.lastUsed.date && (
                      <span>
                        Utilisée{" "}
                        {c.lastUsed.source === "experience" ? "jusqu'en" : "en"}{" "}
                        {c.lastUsed.date.slice(0, 7)}
                      </span>
                    )}
                  </div>
                </Link>
