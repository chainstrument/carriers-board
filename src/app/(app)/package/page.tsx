...
export default async function PackageHistoryPage() {
  ...
  const maxTotal = Math.max(
    1,
    ...withPackage.map((e) => computePackageTotal(e.salaryPackage!)),
  );
    ...
    <div className="mx-auto max-w-3xl px-6 py-16">
      ...
      {withPackage.length === 0 && (
        <p className="text-neutral-500">
          Aucun package configuré pour l&apos;instant. Ajoute un package depuis
          une fiche expérience.
        </p>
      )}
            ...
            <li key={exp.id}>
              ...
              >
                ...
                <div className="mt-1 flex justify-between text-xs text-neutral-500">
                  ...
                  <span>
                    ≈ {formatEuros(Math.round(total * netEstimateRatio))} net
                    estimé
                  </span>
                </div>
              </Link>
            ...
            <table className="w-full text-left text-sm">
              ...
              <tbody>
                {withPackage.map((exp, i) => {
                  ...
                  const previousTotal =
                    i > 0
                      ? computePackageTotal(withPackage[i - 1].salaryPackage!)
                      : null;
