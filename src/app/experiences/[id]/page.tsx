...
function Section({ title, content }: { title: string; content: string | null }) {
  ...
  return (
    <div>
      ...
      <p className="mt-1 whitespace-pre-wrap text-neutral-800 dark:text-neutral-200">{content}</p>
    </div>
  );
}
  ...
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950">
      ...
      <main className="mx-auto max-w-2xl space-y-6 px-6 py-16">
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-neutral-500">
              ...
              {experience.remoteType ? ` · ${experience.remoteType.replace("_", " ")}` : ""}
            </p>
          </div>
        ...
        {experience.manager && (
          <p className="text-sm text-neutral-500">Manager : {experience.manager}</p>
        )}
        ...
        <div className="space-y-4 rounded-lg border border-neutral-200 p-6 dark:border-neutral-800">
          ...
          <Section title="Raison du départ" content={experience.departureReason} />
